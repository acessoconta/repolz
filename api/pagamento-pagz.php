...
try {
    ...
    $apiUrl = 'https://api.usepagz.com.br/functions/v1/transactions';
    $secretKey = 'sk_live_QPm5qcdPqnwQtuZbsqxVsJGPw8oyFI0ec33Zach618R2a4d7'; 
    $companyId = 'd7e641a8-635f-4554-a283-1b550fb80a71'; 
    ...
    error_log("[HydraHub] 🔍 PixCode (primeira tentativa): " . ($pixCode ?? 'NULL'));
